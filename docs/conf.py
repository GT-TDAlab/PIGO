...
latex_documents = [
    (master_doc, 'pigo.tex', 'pigo Documentation',
...
man_pages = [
    (master_doc, 'pigo', 'pigo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pigo', 'pigo Documentation',
     author, 'pigo', 'One line description of project.',
     'Miscellaneous'),
]
...
github_link = 'https://github.com/GT-TDAlab/PIGO/'
